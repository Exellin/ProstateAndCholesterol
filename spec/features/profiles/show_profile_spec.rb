...
RSpec.feature "Viewing a users profile" do
  ...
  scenario "as the owner of the profile" do
    ...
    expect(page).to have_content(@profile.administrative_division)
    ...
    expect(page).to have_content(@profile.ethnicity)
  ...
  scenario "as a guest to the website" do
    ...
    expect(page).not_to have_content(@profile.administrative_division)
    ...
    expect(page).not_to have_content(@profile.ethnicity)
